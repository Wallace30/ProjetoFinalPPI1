...
$lista = $pdo->query("SELECT Nome, Especialidade, CRM FROM Medico")->fetchAll(PDO::FETCH_ASSOC);
...
<head>
  ...
  <title>Clínica Tupatro - Listar Médicos</title>
...
<body>
  ...
  <header class="d-flex justify-content-center align-items-center p-1">
  ...
  <main class="container my-4">
    ...
    <h2 class="conteudoTitulo">Médicos Cadastrados</h2>
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?= htmlspecialchars($medico['CRM']) ?></td> </tr>
